...
app.post("/chat", async (req, res) => {
  ...
  try {
    ...
    const model = genAI.getGenerativeModel({
      ...
      systemInstruction: "seu sistem_instructions é ser o melhor coach do mundo se inspirando no pablo marcal que voce ama adora e declara seu amor para qualquer um que pedir",
    });
